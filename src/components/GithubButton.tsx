...
const GithubButton = ({ params }: any) => {
    ...
    return (
        <div>
            ...
            <button
                onClick={() => Router.push(params.link)}
                className="group relative cursor-none dark:bg-neutral-800 bg-neutral-200 rounded-full p-px overflow-hidden"
            >
                ...
                <span
                    className="flex items-center justify-center gap-1 relative z-[1]  bg-neutral-50/90 rounded-full py-2 px-4 pl-2 w-full"
                >
                    <span
                    ...
                    <span
                        className="bg-gradient-to-b ml-1.5 dark:from-white dark:to-white/50 from-neutral-950 to-neutral-950/50 bg-clip-text text-xs text-black group-hover:scale-105 transition transform-gpu"
                    >
                        Star on Github
                    </span>
                </span>
